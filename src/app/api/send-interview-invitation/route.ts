...
export async function POST(request: NextRequest) {
  try {
    ...
    const supportEmail = 'soporte@talentapro.com'
    ...
    const mailOptions = {
      from: `TalentaPro <${process.env.GMAIL_USER}>`,
      to: candidateEmail,
...
<html lang="es">
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
            <title>Invitación a Entrevista - TalentaPro</title>
  </head>
      ...
      <tr>
        <td>
          <table width="600" align="center" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:16px;box-shadow:0 2px 8px rgba(80,0,120,0.07);margin:40px auto 24px auto;overflow:hidden;">
            <tr>
              <td style="background:linear-gradient(135deg,#5b4aef 0%,#fb33af 100%);padding:36px 0;text-align:center;">
                <a href="https://talentapro.vercel.app/" style="text-decoration:none;">
                  <div style="font-size:2rem;font-weight:700;color:#fff;letter-spacing:1px;display:inline-block;">TalentaPro</div>
                </a>
                <div style="color:#e0d7fa;font-size:1rem;margin-top:8px;">Plataforma Profesional de Entrevistas</div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td style="background:#f6f7fb;text-align:center;padding:24px 0 18px 0;color:#a1a1aa;font-size:0.98rem;border-radius:0 0 16px 16px;">
                © 2024 TalentaPro. Todos los derechos reservados.
              </td>
            </tr>
          </table>
        </td>
